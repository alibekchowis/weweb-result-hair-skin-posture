...
const BorderLinearProgress = styled(LinearProgress)(({ theme }) => ({
  ...
  [`& .${linearProgressClasses.bar}`]: {
    borderRadius: 5,
    backgroundColor: theme.palette.mode === "light" ? "#767DFF" : "#E6E6E6",
  },
}));
...
export default function HairAnalysis() {
  ...
  return (
    <Box sx={{ width: "100%" }}>
      <Divider style={{ margin: "20px 5px", backgroundColor: "#767DFF" }} />

      <Typography
        style={{ marginTop: 5, color: "#767DFF" }}
        variant="h5"
        gutterBottom
        component="div"
      >
      ...
      <Carousel />
      <Divider style={{ margin: "20px 5px", backgroundColor: "#870008" }} />
    </Box>
  );
}
